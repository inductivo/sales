                 ...
                 <li><a  data-toggle="tab" title="Agregar perfiles">
                     ...
                     <div class="tab-content">
                      <div class="tab-pane fade in active" id="home">
                          ...
                          <h3 class="head text-center"> EDITAR GRUPOS</h3>
                          <p class="narrow text-center">

                          <?= form_open('administracion/validar_editar_grupo',array('class'=>'myform-grupos')); ?>
                              ...
                              <?= validation_errors('<div class="alert alert-danger caja-error">','</div>'); ?>
                                ...
                                <div class="span3">
                                     ...
                                     <div class="input-append">
                                       ...
                                       <?=form_hidden ('id_grupos', $registro->id_grupos);?>

                                        <?= form_input(array('class'=>'input_txt', 'type' => 'text','name'=>'grupo','value' => $registro->grupo)); ?>
